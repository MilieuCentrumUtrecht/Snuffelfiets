...
def get_period_info(period_spec, year, quarter, month):
    ...
    Args:
        period_spec: Name of the period to return. One of "jaar", "kwartaal",
            or "maand"
        year: Year for which the info should be returned in YYYY
        quarter: Quarter for which the info should be returned,
            e.g. "QN", where N is 1-4
        month: Month for which the info should be returned,
            1-12

    Returns:
        period_id: The id tag of the queried period
        months: The months contained in the period
    """
...
def get_utrecht_center():
    """Return coordinates for the center of Utrecht province."""

    # Coordinates of the bounds of Utrecht province
    b = {
    ...
    # Calculated center of Utrecht province
    center = {
...
def add_id(df):
    """
    Args:
        df: pd.DataFrame to which the new id should be added
    """
...
def print_id(df):
    """
    Args:
        df: pd.DataFrame containing a unique id to be printed
    """
