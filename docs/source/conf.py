...
project = src_project = PROJECT = "Snuffelfiets"
copyright = f"2023-{datetime.datetime.now().year}, MilieuCentrumUtrecht developers"
mcu = "MilieuCentrumUtrecht"

full_version = Version(snuffelfiets.__version__)
